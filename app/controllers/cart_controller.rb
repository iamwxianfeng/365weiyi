...
class CartController < ApplicationController
  ...
  def index
    ...
    redirect_to "http://www.365weiyi.com/cart/edit"
  end
  ...
  def new
    ...
    if product.blank?
      ...
      redirect_to "http://www.365weiyi.com" and return
    end
    ...
    respond_to do |format|
      ...
      format.html {redirect_to "http://www.365weiyi.com/cart/edit" and return}
    end
  end
